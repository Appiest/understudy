...
export const slides: SlideDefinition[] = [
  ...
  },
  {
    ...
    steps: 3,
    printSteps: [0, 1, 2],
    sourcesByStep: [["metaLiveAi"], ["idcShipments", "essilorResults"], ["metaForWork", "techSpot", "googleXr", "roadToVr"]],
    notes: drivers.notes,
  ...
  },
  {
    ...
    steps: 4,
    printSteps: [0, 1, 2, 3],
    sourcesByStep: [[], [], [], ["metaGlassesPrices", "retrocausal", "mentra", "viture"]],
  ...
  },
  {
    ...
    steps: 3,
    printSteps: [1, 2],
    sourcesByStep: [["kimMauborgne"], ["kimMauborgne"], ["kimMauborgne", "metaGlassesPrices", "hololensPrice"]],
    notes: canvas.notes,
    Content: CanvasSlide,
  },
  {
    ...
    steps: 1,
    sourcesByStep: [["strivrWalmart", "walmartVr", "yoobic", "viture", "retrocausal", "airwave"]],
