...
export const turnover = {
  ...
  notes: [
    "Retail loses about 3.8 percent of its workers every month and restaurants and hotels lose 5.5 percent. Multiplied out over a year, that is roughly half of retail and two thirds of food service. These are BLS numbers for 2025.",
    "Every one of those departures means training someone new. A 2017 industry estimate put the cost at about 4,200 dollars per part-time grocery employee, which adds up to about 67 thousand dollars per store each year. It is dated, so we label it that way.",
...
export const drivers = {
  ...
  glasses: {
    ...
    share: {
      ...
      glasses: [72.9, 84.6],
      headsets: [27.1, 15.4],
      caption: "Share of all XR shipments",
      source: "idcShipments" as SourceId,
    },
    soldIn2025: { value: 7, unit: "million", caption: "Meta and EssilorLuxottica smart glasses sold in 2025, more than triple 2024", source: "uploadVr" as SourceId },
  },
  retreat: {
    heading: "Big players are leaving enterprise headsets",
    today: "Today",
    events: [
      { when: "Feb 20, 2026", what: "Meta stopped selling Quest for Business and Horizon managed services", source: "skillsive" as SourceId },
      { when: "Q2 2026", what: "Reality Labs lost $4.6B as Meta pivots to AI glasses", source: "techSpot" as SourceId },
      { when: "Fall 2026", what: "Google and Samsung launch Android XR glasses with Warby Parker and Gentle Monster", source: "googleXr" as SourceId },
  ...
  notes: [
    ...
    "Second, glasses won. In one year, glasses went from 72.9 to 84.6 percent of XR shipments while headsets fell from 27 to about 15 percent. Meta and EssilorLuxottica sold about 7 million pairs in 2025.",
...
export const solution = {
  ...
  scope: {
    ...
    items: [
      ...
      { key: "Hardware", value: "Off-the-shelf AI glasses around $300, or open platforms like Mentra’s SDK" },
      { key: "Business model", value: "Per-store monthly subscription plus glasses, developed in later weeks" },
    ],
  },
  risks: ["Customer privacy and recording consent", "Battery life (VITURE Helix quotes about 60 minutes while charging)", "Bigger players moving into retail"],
  notes: [
...
export const canvas = {
  ...
  errc: [
    ...
    { action: "Reduce", effect: "lowers cost", items: ["Hardware cost: $300 glasses, not $3,500 headsets", "Time until a new hire is productive", "Owner setup effort"] },
...
export const landscape = {
  ...
  players: [
    { name: "Strivr", offToOn: 0.16, industrialToRetail: 0.7, kind: "rival", source: "strivrWalmart", description: "VR training. Walmart trained 2.2M+ associates across 4,700+ stores and cut Pickup Tower training from 8 hours to 15 minutes." },
    ...
    { name: "VITURE Helix", offToOn: 0.84, industrialToRetail: 0.24, kind: "rival", source: "viture", description: "AI safety glasses for industrial sites. Announced June 2026, ships Q1 2027, from $599." },
    { name: "Retrocausal", offToOn: 0.92, industrialToRetail: 0.07, kind: "rival", source: "retrocausal", description: "Fixed cameras on factory lines that set up live guidance from a single recorded example." },
    { name: "Airwave", offToOn: 0.7, industrialToRetail: 0.38, kind: "rival", source: "airwave", description: "Captures field technicians’ know-how and guides them on the job." },
